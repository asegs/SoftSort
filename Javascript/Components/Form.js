        ...
        if (this.state.topic==="") {
            ...
            for (let step=0;step<this.state.titles.length;step++){
                ...
                if (this.state.titles[step].includes("<M>")){
                    ...
                    items.push(<div><FormElement general={this.state.company==="General"} showNumericsDetails={this.state.detailMode} nameComment={nameComment} minMax={this.state.minMax[step]} counts = {this.state.counts[step]} changeOption = {this.changeOption} changeWeight = {this.changeWeight} num={step} options={undefined} name={this.state.titles[step]} text={0}/></div>);
                }
            ...
            return (
                <div>
                    ...
                    <TopicSelector topics={this.state.topics} setTopic={this.setTopic}/>
                    <br/>
                    Show advanced controls: <input type={"checkbox"} onClick={this.toggleDetailMode}/>
